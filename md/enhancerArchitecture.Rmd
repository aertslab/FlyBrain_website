...
Since DeepFlyBrain requires **500 bp regions** as input, each ehnancer is scored using *500 bp sliding windows with 1 bp shift*, and keeping the subregion with the highest prediction score for the cell type-specific topic. 
