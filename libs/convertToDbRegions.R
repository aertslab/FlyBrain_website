...
convertToDbRegions <- function(regionSets, featherFilePath, minOverlap=0.4, returnCorrespondence=FALSE, applyFun=BiocParallel::bplapply, suppressWarning=FALSE, verbose=TRUE)
{
  ### Check types
  ...
  # Get DB regions:
  dbCols <- RcisTarget::getColumnNames(featherFilePath)
